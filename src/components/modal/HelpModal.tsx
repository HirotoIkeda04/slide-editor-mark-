  ...
  return (
    ...
    >
      <div 
        ...
        style={{ backgroundColor: 'var(--app-bg-tertiary)', border: '1px solid var(--app-border-primary)' }}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold" style={{ color: 'var(--app-text-primary)' }}>使い方</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4" style={{ color: 'var(--app-text-primary)' }}>
          <section>
            ...
            <div className="opacity-90 text-sm mb-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><kbd className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--app-border-primary)' }}>Tab</kbd> キーでインデント（右に移動）</li>
                <li><kbd className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--app-border-primary)' }}>Shift+Tab</kbd> キーでアンインデント（左に移動）</li>
                <li><kbd className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--app-border-primary)' }}>Enter</kbd> キーで改行時、インデントが継続されます</li>
              </ul>
            </div>
          </section>
          <section>
            ...
            <div className="opacity-90 text-sm mb-3">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li><code className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--app-border-primary)' }}>! </code> キーメッセージ</li>
              </ul>
            </div>
...
コンテンツ`}
          ...
          <section>
            ...
            <div className="opacity-90 text-sm mb-2">
              <p>行頭に <code className="px-1 py-0.5 rounded" style={{ backgroundColor: 'var(--app-border-primary)' }}>! </code>（感嘆符+半角スペース）で始まる行をキーメッセージとして認識します。</p>
            </div>
            <div className="opacity-70 text-xs mb-2">例：</div>
            <pre className="p-2 rounded text-xs" style={{ backgroundColor: 'var(--app-bg-primary)', color: 'var(--app-highlight)' }}>
{`! これはキーメッセージです
